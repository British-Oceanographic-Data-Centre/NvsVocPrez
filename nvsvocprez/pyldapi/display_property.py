...
class DisplayProperty:
    def __init__(
        ...
        if predicate_uri in [
            ...
            self.object_html = f'<td style="white-space: nowrap;"><code><a href="{related_col_systemUri}">{related_col_id}</a>:<a href="{related_systemUri}">{related_id}</a></code></td><td colspan="2">{html.escape(object_label)}</td>'
