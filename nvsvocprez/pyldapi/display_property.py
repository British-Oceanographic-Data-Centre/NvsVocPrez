class DisplayProperty:
    def __init__(
        ...
        if predicate_uri in [
            ...
            self.object_html = (
                f'<td style="white-space: nowrap;"><code><a href="{related_col_systemUri}">{related_col_id}</a>:'
                f'<a href="{related_systemUri}">{related_id}</a></code></td>'
                f'<td>{object_label}</td><td style="white-space: nowrap;"><a href="{mapping_url}">Mapping</a></td>'
            )
